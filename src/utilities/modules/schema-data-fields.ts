...
import { Predicate, PredicateStatement, RawPredicate } from "foundry-pf2e";
import * as R from "remeda";
import { Utilities } from "..";
import { SlugCamel } from "../../../types/pf2e/util";
import fields = foundry.data.fields;
import validation = foundry.data.validation;

/** A `SchemaField` that prunes undefined values */
export class PrunedSChemaField<
...
export class StrictSchemaField<TDataSchema extends DataSchema> extends fields.SchemaField<TDataSchema> {
    protected override _cast(value: unknown): SourceFromSchema<TDataSchema> {
        return value as SourceFromSchema<TDataSchema>;
    }

    protected override _cleanType(data: object, options?: fields.CleanFieldOptions): SourceFromSchema<TDataSchema> {
...
export class StrictStringField<
...
export class StrictNumberField<
...
> extends fields.BooleanField<boolean, boolean, TRequired, TNullable, THasInitial> {
    ...
    protected override _toInput(config: foundry.data.FormInputConfig<boolean | null>): HTMLElement {
...
export class StrictBooleanField<
    TRequired extends boolean = true,
    TNullable extends boolean = false,
    THasInitial extends boolean = true,
> extends fields.BooleanField<boolean, boolean, TRequired, TNullable, THasInitial> {
...
export class StrictObjectField<
...
export type JSONPrimitive = Exclude<JSONValue, "object">;

export /** A field that allows nothing except for the provided choices */
...
> extends fields.DataField<TChoices, TChoices, TRequired, TNullable, THasInitial> {
    ...
    protected override _validateType(value: unknown): void {
        ...
        if (!Utilities.Misc.tupleHasValue(this.choices, value)) {
...
export interface AnyChoiceField<
    TChoices extends JSONPrimitive,
    TRequired extends boolean = true,
    TNullable extends boolean = false,
    THasInitial extends boolean = true,
...
export interface AnyChoiceFieldOptions<
    TChoices extends JSONPrimitive,
...
> extends StrictStringField<string, string, TRequired, TNullable, THasInitial> {
    ...
    protected override _cleanType(value: Maybe<string>, options?: CleanFieldOptions): unknown {
        ...
        return typeof slug === "string" ? game.pf2e.system.sluggify(slug, { camel }) : slug;
    }
}
...
> {
    ...
    protected override _validateType(value: unknown): boolean {
        return Utilities.Predication.StatementValidator.isStatement(value);
    }
...
> extends StrictArrayField<PredicateStatementField, RawPredicate, Predicate, TRequired, TNullable, THasInitial> {
    ...
    override initialize(
        ...
        return Array.isArray(statements) ? new game.pf2e.Predicate(...statements) : statements;
    }
...
export class NullField extends fields.DataField<null, null, true, true, true> {
    constructor() {
