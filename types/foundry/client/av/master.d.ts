...
declare global {
    ...
    class AVMaster {
         ...
         * @defaultValue `null`
         */
        private _connecting: Promise<boolean> | null;
         ...
         * @defaultValue `{}`
         */
        _speakingData: { speaking: boolean; volumeHistories: number[] };
        ...
        get mode(): typeof AVSettings.AV_MODES;
         ...
         */
        private _initializeUserVoiceDetection(mode: typeof AVSettings.VOICE_MODES): void;
         ...
         */
        private _onAudioLevel(dbLevel: number): void;
