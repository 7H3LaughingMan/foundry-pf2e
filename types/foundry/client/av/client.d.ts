...
declare global {
    ...
    abstract class AVClient {
         ...
         */
        private _getSourcesOfType(kind: MediaDeviceKind): Promise<Record<string, string>>;
         ...
         */
        abstract getMediaStreamForUser(userId: string): Maybe<MediaStream>;
         ...
         */
        abstract getLevelsStreamForUser(userId: string): Maybe<MediaStream>;
         ...
         * @param videoElement he HTMLVideoElement to which the video should be set
         */
         ...
         */
        onSettingsChanged(changed: DeepPartial<AVSettings["_original"]>): void;
