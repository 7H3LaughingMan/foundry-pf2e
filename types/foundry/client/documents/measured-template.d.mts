...
interface CanvasBaseMeasuredTemplate<TParent extends Scene | null> extends InstanceType<typeof CanvasBaseMeasuredTemplate<TParent>> {}
 ...
 */
export default class MeasuredTemplateDocument<TParent extends Scene | null = Scene | null> extends CanvasBaseMeasuredTemplate<TParent> {
    /* -------------------------------------------- */
    /*  Model Properties                            */
    /* -------------------------------------------- */
...
export default interface MeasuredTemplateDocument<TParent extends Scene | null = Scene | null> extends CanvasBaseMeasuredTemplate<TParent> {
