...
declare global {
    interface Set<T> {
         ...
         */
        every(test: (element: T, index: number, set: Set<T>) => boolean): boolean;
        every<U extends T = T>(test: (element: T, index: number, set: Set<T>) => element is U): this is Set<U>;
         ...
         */
        filter(test: (element: T, index: number, set: Set<T>) => boolean): Set<T>;
        filter<U extends T = T>(test: (element: T, index: number, set: Set<T>) => element is U): Set<U>;
         ...
         */
        find(test: (element: T, index: number, set: Set<T>) => boolean): T | undefined;
        find<U extends T = T>(test: (element: T, index: number, set: Set<T>) => element is U): U | undefined;
         ...
         */
        reduce(reducer: (accumulator: T, currentValue: T, currentIndex: number, set: Set<T>) => T, accumulator: T): T;
        reduce<U>(
            reducer: (accumulator: U, currentValue: T, currentIndex: number, set: Set<T>) => U,
            accumulator: U,
        ): U;
         ...
         */
        some(test: (element: T, index: number, set: Set<T>) => boolean): boolean;
    }
}
