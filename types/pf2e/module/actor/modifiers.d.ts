import type { ActorPF2e, CharacterPF2e, NPCPF2e } from "types/pf2e/module/actor/index.ts";
...
import type { DamageCategoryUnique, DamageDiceFaces, DamageDieSize, DamageType } from "types/pf2e/module/system/damage/types.ts";
