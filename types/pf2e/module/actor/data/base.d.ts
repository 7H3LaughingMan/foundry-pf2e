...
import type { DexterityModifierCapData } from "types/pf2e/module/actor/character/types.ts";
import type { Abilities } from "types/pf2e/module/actor/creature/data.ts";
import type { InitiativeTraceData } from "types/pf2e/module/actor/initiative.ts";
import type { StatisticModifier } from "types/pf2e/module/actor/modifiers.ts";
import type { ActorAlliance, AttributeString, SkillSlug } from "types/pf2e/module/actor/types.ts";
...
import type { MigrationRecord, Rarity, Size, ValueAndMaybeMax, ZeroToTwo } from "types/pf2e/module/data.ts";
import type { AutoChangeEntry } from "types/pf2e/module/rules/rule-element/ae-like.ts";
import type { AttackRollParams, DamageRollParams, RollParameters } from "types/pf2e/module/system/rolls.ts";
import type { CheckRoll } from "types/pf2e/module/system/check/roll.ts";
import type { DamageRoll } from "types/pf2e/module/system/damage/roll.ts";
import type { StatisticTraceData } from "types/pf2e/module/system/statistic/data.ts";
