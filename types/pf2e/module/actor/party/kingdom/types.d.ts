import { KINGDOM_SCHEMA, KINGDOM_SETTLEMENT_SCHEMA } from './schema.ts';
import { KINGDOM_ABILITIES, KINGDOM_COMMODITIES, KINGDOM_LEADERSHIP, KINGDOM_SETTLEMENT_TYPES, KINGDOM_SKILLS } from './values.ts';
