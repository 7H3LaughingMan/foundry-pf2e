...
import type { CheckModifier, ModifierPF2e, ModifierType, StatisticModifier } from "types/pf2e/module/actor/modifiers.ts";
...
import type { CompendiumBrowser, CompendiumBrowserSettings, CompendiumBrowserSources } from "types/pf2e/module/apps/compendium-browser/index.ts";
...
import type { ActorDirectoryPF2e, ChatLogPF2e, CompendiumDirectoryPF2e, EncounterTrackerPF2e } from "types/pf2e/module/apps/sidebar/index.ts";
...
import type { AmbientLightDocumentPF2e, MeasuredTemplateDocumentPF2e, RegionBehaviorPF2e, RegionDocumentPF2e, ScenePF2e, TileDocumentPF2e, TokenDocumentPF2e } from "types/pf2e/module/scene/index.ts";
...
import type { calculateXP, checkPrompt, editPersistent, launchTravelSheet, perceptionForSelected, rollActionMacro, rollItemMacro, stealthForSelected, xpFromEncounter } from "types/pf2e/scripts/macros/index.ts";
...
import type { CustomDamageData, HomebrewTag, HomebrewTraitSettingsKey, LanguageSettings } from "types/pf2e/module/system/settings/homebrew/index.ts";
